...
public class GuiT extends PApplet {
	...
	// Fixe GrÃ¶ÃŸen
//	final private int getEinfahrtkap = 23;	//TODO: Hier wurde was geändert!
...
//	int naechstesAutoEinfahrtInt = minAnkunft
//			+ rand.nextInt(maxAnkunft - minAnkunft);
//	Uhrzeit startzeit = new UhrzeitImpl(10, 0, 0);
//	Uhrzeit naechstesAutoEinfahrt = new UhrzeitImpl(naechstesAutoEinfahrtInt)
//			.addiere(startzeit);
...
//	ZustandsUmgebung umgebung = new ZustandsUmgebung(autoAbstand,
//			baustellenZeit, minParkDauer, maxParkDauer, minAutoAnkunft,
//			maxAutoAnkunft, maxRot, PARKHAUS_KAPAZITAET, EINFAHRTKAPAZITAET); //TODO: Hier wurde was geändert!
//	Zustand zustand = new ZustandImpl(0, 0, Zustand.STOP_AUSFAHRT,
//			naechstesAutoEinfahrt, startzeit, new PriorityQueue<Uhrzeit>(),
//			new PriorityQueue<Uhrzeit>(), naechstesAutoEinfahrt,
//			new UhrzeitImpl(0, 0, 0), umgebung);
	//TODO: Neu hinzugefügt... bitte einmal testen
...
//        private int zustand.getParkhausgroesse() = zustand.getParkhausgroesse();
//        private int zustand.getEinfahrtgroesse() = zustand.getEinfahrtgroesse();
	...
	@Override
	public void setup() {
            System.out.println(zustand.getParkhausgroesse());
            System.out.println(zustand.getEinfahrtgroesse());
		size(502, 576);
		background(255);
		frameRate(30);
		image(welt, 0, 0);
		...
		fill(0);
		rect(132, 10, 15, 15);
		// Parkplatz mit 10x10 Plï¿½tzen
		fill(255);
//		 zeichneRaster(PARKHAUSX, PARKHAUSY, PARKHAUSSPALTEKAPAZITAET,
//		 PARKHAUSZEILEKAPAZITAET);
		//TODO: Hier wurde was geändert!
		zeichneParkplatz(PARKHAUSX, PARKHAUSY, zustand.getParkhausgroesse());
		
		// Warteschlange vor der Ausfahrt
		// zeichneRaster(AUSFAHRTWARTEBEREICHX, AUSFAHRTWARTEBEREICHY,
		// AUSFAHRTKAPAZITAET, 1);
		// Wartebereich vor der Einfahrt
		zeichneRaster(EINFAHRTWARTEBEREICHX, EINFAHRTWARTEBEREICHY,
				zustand.getEinfahrtgroesse(), 1);
		// Baustellenbereich
		// zeichneRaster(BAUSTELLENBEREICHX, BAUSTELLENBEREICHY, 1,
		// zustand.getBaustellenAutos());
	}
	...
	private void addiereAutos(String wo) {
		...
		case "P":
//TODO: Hier wurde was geändert!
//			if (this.posParkplatz < PARKHAUSSPALTEKAPAZITAET
//					* PARKHAUSZEILEKAPAZITAET) {
	 ...
	 * zeichneParkplatz
	 * 
	 * Beschreibung: Zeichnet das Raster für den Parkplatz, wobei die maximale
	 * Spalten- und Zeilengröße von 20 festgelegt ist.
	 * 
	 * WICHTIG: Hier könnte noch verbessert werden das er nicht immer 20*20
	 * Schritte macht wenn z.B. nur ein Parkplatz vorhanden ist.
	 */
